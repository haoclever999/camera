    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <form action="{{ route('nguoidung.posthoso', ['id' => $user->id]) }}" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('sdt') is-invalid @enderror" id="sdt"
                                    name="sodt" onblur="kiemTraSDT(event)" placeholder="Nhập số điện thoại"
                                    value="{{ $user->sdt }}" maxlength="10" required />
                                @if ($errors->has('sdt'))
                                    <span class="help-block" style="color: #ff3f3f">
                                    ...
                                    <div class="form-group row col-md-12 " style="padding-left: 20px; ">
                                            ...
                                            <select class="opt_select opt_Tinh" name="opt_Tinh" id="opt_Tinh"
                                                ...
                                                @foreach ($tinh_tp as $tinh)
                                                    <option value="{{ $tinh->id }}"
                                                        {{ $tinh->ten_tp == $dc[3] ? 'selected' : '' }}>{{ $tinh->ten_tp }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-4" style="padding-left: 0;margin: 0;">
                                            ...
                                            <select class="opt_select opt_Huyen" name="opt_Huyen" id="opt_Huyen"
                                                style="width: 12em; margin-left: 0; " required>
                                                @foreach ($huyen as $h)
                                                    <option
                                                        value="{{ $h->id }}"{{ $h->ten_qh == $dc[2] ? 'selected' : '' }}>
                                                        {{ $h->ten_qh }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-4" style="padding-left: 0;padding-right: 0;">
                                            ...
                                            <select class="opt_Xa" name="opt_Xa" id="opt_Xa" style="width: 12em; "
                                                required>
                                                @foreach ($xa as $x)
                                                    <option
                                                        value="{{ $x->id }}"{{ $x->ten_xa == $dc[1] ? 'selected' : '' }}>
                                                        {{ $x->ten_xa }}</option>
                                                @endforeach
                                            </select>
                                        </div>
