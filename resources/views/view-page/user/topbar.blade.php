        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-9 additional-shop-info">
                <ul class="list-unstyled list-inline">
                    ...
                    <li>
                        <a target="_blank" href="{{ $fb->gia_tri }}" style="text-decoration: none">
            ...
            <div class="col-md-3 col-sm-3 additional-nav">
                <ul class="list-unstyled list-inline pull-right">
                    @if (Auth::check())
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown" style="margin-top: 0">
                                ...
                                <a class="dropdown-item" href="{{ route('DangXuatUser') }}"
                                    style="text-decoration: none">
                    ...
                    @else
                        <li>
                            <a href="{{ route('getDangNhapUser') }}" style="text-decoration: none">
                                Đăng nhập
                            </a>
                        </li>
                    @endif
