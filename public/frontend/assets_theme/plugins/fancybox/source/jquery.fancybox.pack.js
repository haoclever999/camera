...
(function (B, x, f, q) {
    ...
    f.extend(b, {
        ...
        next: function (a) {
            var d = b.current;
            d &&
                (p(a) || (a = d.direction.next),
                b.jumpto(d.index + 1, a, "next"));
        },
        prev: function (a) {
            var d = b.current;
            d &&
                (p(a) || (a = d.direction.prev),
        ...
        _setDimension: function () {
            ...
            B = n;
            h.fitToView &&
                ((m = Math.min(a.w - z, m)), (n = Math.min(a.h - s, n)));
            z = a.w - y;
            q = a.h - q;
            h.aspectRatio
                ? (c > m && ((c = m), (i = k(c / D))),
    ...
    b.helpers.overlay = {
        ...
        open: function (a) {
            ...
            this.overlay
                ...
                : this.create(a);
            this.fixed ||
                (r.bind("resize.overlay", f.proxy(this.update, this)),
                this.update());
            a.closeClick &&
        ...
        close: function () {
            ...
            this.overlay = null;
            !1 !== this.margin &&
                (f("body").css("margin-right", this.margin),
                (this.margin = !1));
        ...
        beforeShow: function (a, b) {
            b.locked &&
                ...
                !1 !== this.margin &&
                    f("body").css(
                        "margin-right",
                        k(this.margin) + b.scrollbarWidth
                    ));
            this.open(a);
        },
        onUpdate: function () {
