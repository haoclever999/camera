<div class="sidebar col-md-3 col-sm-4">
    ...
    <ul class="list-group margin-bottom-25 sidebar-menu">
        @foreach($dm as $d)
        <li class="list-group-item clearfix dropdown {{ Request::segment(2) == $d->slug || Request::segment(2) == $d->id ? 'active' : ''}}">
            <a
    ...
    <ul class="list-group margin-bottom-25 sidebar-menu">
        ...
        <li class="list-group-item clearfix dropdown {{ Request::segment(4) == $th->slug ? 'active' : ''}}">
            <a
