            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="row product-list" style="min-height: 300px">
                        <div class="col-md-10">
                            <form action="{{ route('nguoidung.posthosoUser', ['id' => $user->id]) }}" method="post">
                                @csrf
                                <br>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('ho_ten') is-invalid @enderror"
                                        id="ho_ten" name="ten_nd" placeholder="Nhập tên người dùng"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email"
                                        value="{{ $user->email }}" style="cursor: no-drop" disabled />
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('sdt') is-invalid @enderror"
                                        id="sdt" name="sodt" placeholder="Nhập số điện thoại"
                                        value="{{ $user->sdt }}" maxlength="10" onblur="kiemTraSDT(event)" required />
                                </div>
                                <div class="form-group">
                                        ...
                                        <div class="form-group col-md-12 col-sm-12 " style="padding-left: 10px;">
                                                ...
                                                <select class="opt_select opt_Tinh" name="opt_Tinh" id="opt_Tinh"
                                                    ...
                                                    @foreach ($tinh_tp as $tinh)
                                                        <option value="{{ $tinh->id }}"
                                                            {{ $tinh->ten_tp == $d_c[3] ? 'selected' : '' }}>{{ $tinh->ten_tp }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-4 col-sm-4" style="padding-left: 0;">
                                                ...
                                                <select class="opt_select opt_Huyen" name="opt_Huyen" id="opt_Huyen"
                                                    style="width: 100%; margin-left: 0; " required>
                                                    @foreach ($huyen as $h)
                                                        <option
                                                            value="{{ $h->id }}"{{ $h->ten_qh == $d_c[2] ? 'selected' : '' }}>
                                                            {{ $h->ten_qh }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-4 col-sm-4" style="padding-left: 0; padding-right: 0;">
                                                ...
                                                <select class="opt_Xa" name="opt_Xa" id="opt_Xa" style="width: 100%; "
                                                    required>
                                                    @foreach ($xa as $x)
                                                        <option
                                                            value="{{ $x->id }}"{{ $x->ten_xa == $d_c[1] ? 'selected' : '' }}>
                                                            {{ $x->ten_xa }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    @else
                                        <div class="form-group col-md-12 col-sm-12 " style="padding-left: 10px;">
                                            ...
                                            <div class="col-md-4 col-sm-4" style="padding-left: 0; padding-right: 0;">
                                                <label for="opt_Xa"> Chọn Xã phường/Thị trấn </label><br>
                                                <select class="opt_Xa" name="opt_Xa" id="opt_Xa"
                                                    style="width: 160px; " required>
                                    ...
                                    <div class="form-group" style="padding-left: 10px;">
                                        ...
                                        <input type="text" class="form-control" name="dia_chi" id="dia_chi"
                                            value="{{ $d_c[0] }}" placeholder="Nhập số nhà, khóm/ấp" required>
                                        </input>
                                    </div>
                                </div>
