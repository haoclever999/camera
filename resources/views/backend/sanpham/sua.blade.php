    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ route('sanpham.postSua', ['id' => $sp->id]) }}" method="post"
                            ...
                            <div class="col-md-6" style="float: left">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('ten_sp') is-invalid @enderror"
                                        name="ten_spham" id="ten_sp" value="{{ $sp->ten_sp }}" onchange="changeName()"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4" style="float: left">
                                            <input type="text" class="form-control" value="{{ $sp->so_luong }}"
                                                disabled />
                                        </div>
                                        ...
                                        <div class="form-group col-md-8" style="float: right">
                                            <input type="number"
                                                ...
                                                id="num_so_luong" name="num_so_luong" max="999999" step="1"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('num_gia_nhap') is-invalid @enderror"
                                        id="num_gia_nhap" name="num_gia_nhap" value="{{ $sp->gia_nhap }}" max="999999999"
                                        min="1000" step="1" placeholder="Nhập giá nhập" required />
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('num_gia_ban') is-invalid @enderror"
                                        id="num_gia_ban" name="num_gia_ban" value="{{ $sp->gia_ban }}" max="999999999"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('num_giam_gia') is-invalid @enderror"
                                        id="num_giam_gia" name="num_giam_gia" value="{{ $sp->giam_gia }}" max="100"
                                        min="0" step="1" placeholder="Nhập giảm giá" required />
                                </div>
                            </div>
                            <div class="col-md-6" style="float: right">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('num_bao_hanh') is-invalid @enderror"
                                        name="num_bao_hanh" id="num_bao_hanh" value="{{ $sp->bao_hanh }}"
                                        placeholder="Nhập bảo hành" max="99" min="0" step="1"
                                        required />
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="opt_tagsp[]"
                                        ...
                                        @foreach ($sp->SanPhamTag as $tagItem)
                                            <option value="{{ $tagItem->ten_tag }}" selected>
                                                {{ $tagItem->ten_tag }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group col-md-12" style="float: left">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control-file" id="fdaidien" name="fdaidien"
                                        accept="image/jpg, image/png, image/jpeg" onchange="preview(event)" />
                                    <div class="fdaidien_container col-md-3" id="container_preview">
                                        <img id="img_dai_dien" class="sp_img_dai_dien"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control-file" id="fchitiet" name="fchitiet[]"
                                        onchange="preview_Multiple()" multiple
                                        accept="image/jpg, image/png, image/jpeg, video/mp4" />
                                    <div class="col-md-12 fchitiet_container">
                                        <div class="row" id="container_previewMultiple">
                                            @foreach ($sp->HinhAnh as $hanh)
                                                <div id="pre_Multiple">
                                                    <img class="sp_img_chi_tiet" src="{{ $hanh->hinh_anh }}"
                                                        alt="HaoNganTelecom" />
                                                </div>
                                            @endforeach
                                        </div>
