...
@extends('layouts.admin') @section('title')
    ...
    <div class="input-group timkiem">
        <input type="search" class="form-control bg-light border-0 small" placeholder="Tìm kiếm..." name="timkiem_cauhinh"
            id="timkiem_cauhinh" />
    </div>
                            ...
                            @foreach ($cauhinh as $ch)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        margin: 3px;
                                    "
                                            class="btn btn-warning" href="{{ route('cauhinh.getSua', ['id' => $ch->id]) }}">
                                            Cập nhật
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <form action="{{ route('cauhinh.postThem') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('ten') is-invalid @enderror" id="ten"
                                name="ten" value="{{ old('ten') }}" placeholder="Nhập tên cấu hình" required />
                            @if ($errors->has('ten'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('gia_tri') is-invalid @enderror" id="gia_tri"
                                name="gia_tri" value="{{ old('gia_tri') }}" placeholder="Nhập giá trị của cấu hình"
                                required />
        ...
        $(document).ready(function() {
            ...
            $("#timkiem_cauhinh").on("keyup", function(e) {
                ...
                $.ajax({
                    ...
                    method: "GET",
                    data: {
                        timkiem_cauhinh: timkiem_cauhinh
                    },
