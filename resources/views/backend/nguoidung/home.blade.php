                ...
                <table class="table" style="min-width: max-content">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form
                                    action="{{ route('nguoidung.trangthai', ['id' => $u->id]) }}"
                                    method="post"
                                >
                                    @csrf
                                    <input
                                    ...
                                    <button
                                        type="submit"
                                        class="btn btn-danger action_edit"
                                    >
                                        Khóa
                                    </button>
                                </form>
                            ...
                            <td>
                                <form
                                    action="{{ route('nguoidung.postcapnhatquyen', ['id' => $u->id]) }}"
                                    method="post"
                                    style="display: none"
                                    class="fcapnhatquyen"
                                >
                                    ...
                                    <select id="opt_quyen" name="opt_quyen">
                                        <option {{$u->
                                            quyen=="Quản trị" ?'selected':''}}
                                            value="Quản trị">Quản trị
                                        </option>
                                        <option {{$u->
                                            quyen=="Nhân viên" ?'selected':''}}
                                            value="Nhân viên">Nhân viên
                                        </option>
                                        <option {{$u->
                                            quyen=="Khách hàng" ?'selected':''}}
