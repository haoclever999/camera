...
@extends('layouts.admin') @section('title')
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-5">
                        <form action="{{ route('danhmuc.postSua', ['id' => $dm->id]) }}" method="post">
                            @csrf
                            <div class="form-group">
                                <label for="ten_dm" class="form-label">
                                    <b>Tên danh mục</b>
                                </label>
                                <input type="text" class="form-control @error('ten_dm') is-invalid @enderror"
                                    id="ten_dm" name="ten_dm2" onchange="changeName()" value="{{ $dm->ten_dm }}"
    ...
    <script>
        function changeName() {
            document.getElementById("ten_dm").setAttribute("name", "ten_dm");
        }
    </script>
@endsection
