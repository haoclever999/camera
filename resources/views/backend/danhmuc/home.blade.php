...
@extends('layouts.admin') @section('title')
    ...
    <div class="input-group timkiem">
        <input type="search" class="form-control bg-light border-0 small" placeholder="Tìm kiếm..." name="timkiem_dm"
            id="timkiem_dm" />
    </div>
    ...
    <div class="content-wrapper content container-fluid" style="padding-left: 10px; padding-right: 10px">
        ...
        <div class="row">
            @if (auth()->check() && auth()->user()->quyen == 'Quản trị')
                @if ($dm_daxoa->count() > 0)
                    <div>
                        <a href="{{ route('danhmuc.daxoa') }}" class="btn btn-danger float-left m-2" id="delete">
                            Đã xóa
                        </a>
                    </div>
                @endif
                            ...
                            @foreach ($dm as $d)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        margin: 3px;
                                    "
                                            class="btn btn-warning" href="{{ route('danhmuc.getSua', ['id' => $d->id]) }}">
                                            Cập nhật
                                        </a>
                                        @if (auth()->check() && auth()->user()->quyen == 'Quản trị')
                                            <a style="
                ...
                <div class="col-md-4" style="float: right">
                    ...
                    <form action="{{ route('danhmuc.postThem') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('ten_dm') is-invalid @enderror" id="ten_dm"
                                name="ten_dm" value="{{ old('ten_dm') }}" placeholder="Nhập tên danh mục" required />
