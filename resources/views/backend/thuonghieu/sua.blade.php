    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <form action="{{ route('thuonghieu.postSua', ['id' => $th->id]) }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('ten_thuong_hieu') is-invalid @enderror"
                                    id="ten_thuong_hieu" name="ten_thuong_hieu2" value="{{ $th->ten_thuong_hieu }}"
                                    onchange="changeName()" placeholder="Nhập tên thương hiệu" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file" id="logo_thuong_hieu"
                                    name="logo_thuong_hieu" accept="image/jpg, image/png, image/jpeg"
                                    onchange="preview(event)" />
                                <div class="logo_container col-md-3" id="container_preview">
                                    <img id="img_logo" class="img_logo" src="{{ $th->logo }}" />
                                </div>
                            </div>
