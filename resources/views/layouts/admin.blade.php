...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/vendor/bootstrap/css/bootstrap-icons.css') }}" type="text/css" />
    <link rel="stylesheet" href="{{ asset('frontend/vendor/bootstrap/css/bootstrap.css') }}" type="text/css" />

    <link
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet" type="text/css" />

    <link href="{{ asset('frontend/css/sb-admin-2.min.css') }} " rel="stylesheet" type="text/css" />

    <link rel="stylesheet" href="{{ asset('frontend/css/camera.css') }}" type="text/css" />
