        ...
        <div class="col-md-9 col-sm-7">
            <div class="content">
                <div class="col-md-7 col-sm-7">
                    ...
                    @if ($errors->any() || Session::has('err') || Session::has('err_pw_cu'))
                ...
                <div class="container-fluid">
                    <div class="row product-list" style="min-height: 300px">
                        <div class="col-md-10">
                            <form action="{{ route('nguoidung.postdoimatkhauUser', ['id' => $user->id]) }}" method="post">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control @error('password') is-invalid @enderror"
                                        id="password" name="password" placeholder="Nhập mật khẩu cũ" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control @error('password_new') is-invalid @enderror"
                                        id="password_new" name="password_new" placeholder="Nhập mật khẩu mới" required />
                                    <span class="fa fa-fw fa-eye field-icon toggle-password"
                                        style="
                                        float: right;
                                        margin-left: -25px;
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password"
                                        ...
                                        id="password_confirm" name="password_confirm" placeholder="Nhập lại mật khẩu mới"
                                        required />
                                    <span class="fa fa-fw fa-eye field-icon toggle-password"
                                        style="
                                        float: right;
