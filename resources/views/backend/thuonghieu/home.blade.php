...
@extends('layouts.admin') @section('title')
    ...
    <div class="input-group timkiem">
        <input type="search" class="form-control bg-light border-0 small" placeholder="Tìm kiếm..." name="timkiem_th"
            id="timkiem_th" />
    </div>
    ...
    <div class="content-wrapper content container-fluid" style="padding-left: 10px; padding-right: 10px">
        ...
        <div class="row">
            @if (auth()->check() && auth()->user()->quyen == 'Quản trị')
                @if ($th_daxoa->count() > 0)
                    <div>
                        <a href="{{ route('thuonghieu.daxoa') }}" class="btn btn-danger float-left m-2" id="delete">
                            Đã xóa
                        </a>
                    </div>
                @endif
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4" style="float: right">
                    ...
                    <form action="{{ route('thuonghieu.postthem') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="ten_thuong_hieu" class="form-label">
                                <b> Tên thương hiệu </b>
                            </label>
                            <input type="text" class="form-control @error('ten_thuong_hieu') is-invalid @enderror"
                                id="ten_thuong_hieu" name="ten_thuong_hieu" placeholder="Nhập tên thương hiệu"
                                value="{{ old('ten_thuong_hieu') }}" required />
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control-file" id="logo_thuong_hieu" name="logo_thuong_hieu"
                                accept="image/jpg, image/png, image/jpeg" required />
                            <div class="logo_container col-md-3" id="container_preview" style="margin-top: 1rem"></div>
                        </div>
