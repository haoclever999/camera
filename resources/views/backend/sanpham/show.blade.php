            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-12" style="float: right">
                        <!-- Topbar Search -->
                        <a href="{{ route('sanpham.getSua', ['id' => $sp->id]) }}" class="btn btn-warning float-right m-2">
                            Cập nhật sản phẩm
                        </a>
                    </div>
                    <!-- /.col -->
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6" style="float: left">
                            ...
                            <div class="form-group">
                                <label class="form-label">
                                    <b>Giá nhập: </b>
                                    <span>{{ number_format($sp->gia_nhap, 0, ',', '.') }}</span>
                                    đ
                                </label>
                            </div>
                        ...
                        <div class="form-group col-md-12" style="float: left">
                            <div class="form-group">
                                ...
                                <div class="fdaidien_container col-md-3">
                                    <img class="sp_img_dai_dien" src="{{ $sp->hinh_anh_chinh }}" />
                                </div>
                            </div>
